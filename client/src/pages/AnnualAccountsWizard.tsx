...
export default function AnnualAccountsWizard() {
  ...
  const form = useForm<AnnualAccountsFormData>({
    ...
    defaultValues: {
      ...
      // Directors Report
      directorsReport_principalActivities: "",
      directorsReport_businessReview: "",
      directorsReport_futureDevelopments: "",
      // Cash Flow Statement
      cashFlow_operatingProfit: 0,
      cashFlow_depreciation: 0,
      cashFlow_inventoryChange: 0,
      cashFlow_debtorsChange: 0,
      cashFlow_creditorsChange: 0,
      cashFlow_netCashFromOperating: 0,
      cashFlow_purchaseFixedAssets: 0,
      cashFlow_saleFixedAssets: 0,
      cashFlow_netCashFromInvesting: 0,
      cashFlow_shareCapitalIssued: 0,
      cashFlow_newLoans: 0,
      cashFlow_loanRepayments: 0,
      cashFlow_dividendsPaid: 0,
      cashFlow_netCashFromFinancing: 0,
      cashFlow_netCashChange: 0,
      cashFlow_openingCash: 0,
      cashFlow_closingCash: 0,
      // Strategic Report
      strategicReport_businessModel: "",
      strategicReport_strategy: "",
      strategicReport_kpis: "",
      strategicReport_principalRisks: "",
      strategicReport_section172: "",
      // Notes to Accounts
      notes_basisOfPreparation: "",
      notes_goingConcern: "",
      notes_accountingPolicies: "",
      // Exemptions
      exemptions_auditExempt: false,
      exemptions_abbreviatedAccounts: false,
      exemptions_dormant: false,
      exemptions_shareholderConsent: "",
      // AI Assistance Flags
