  ...
  return (
    <section>
      <div className="flex justify-between items-center mb-3">
        ...
        <Link href="/filings?status=draft">
              ...
              <Link href={`/filings/${draft.id}`}>
                <a className="block">
                  ...
                  <div className="mt-2">
                    ...
                    <Progress value={draft.progress} className="h-1.5 bg-neutral-200" indicatorClassName="bg-[hsl(var(--secondary-500))]" />
                  </div>
                </a>
              </Link>
            </div>
              ...
              <Link href="/filings/1">
                <a className="block">
                  ...
                  <div className="mt-2">
                    ...
                    <Progress value={60} className="h-1.5 bg-neutral-200" indicatorClassName="bg-[hsl(var(--secondary-500))]" />
                  </div>
                </a>
              </Link>
            </div>
              ...
              <Link href="/filings/2">
                <a className="block">
                  ...
                  <div className="mt-2">
                    ...
                    <Progress value={25} className="h-1.5 bg-neutral-200" indicatorClassName="bg-[hsl(var(--secondary-500))]" />
                  </div>
                </a>
              </Link>
            </div>
